...
export default function UploadImageScreen({ navigation }: { navigation: StackNavigationProp<any> }) {
    ...
    const showImagePickerOptions = () => {
        Alert.alert(
            'Pilih Sumber Gambar',
            'Pilih dari mana Anda ingin mengambil foto bahan makanan',
            [
    ...
    const uploadImageAndGenerateMenu = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.BASE_URL}/api/upload`, formData, {
                headers:
                {
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>
                        Upload your meal photo and associate it with a plan
                    </Text>
                </View>
