...
export default function ProfileFormScreen({ navigation }: { navigation: StackNavigationProp<any> }) {
    ...
    const checkUserProfile = async () => {
        try {
            ...
            const response = await axios.get(
                `${process.env.BASE_URL}/api/profiles/${storedUserId}`,
                {
                    headers: {
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            const response = await axios.patch(
                `${process.env.BASE_URL}/api/profiles/${userId}`,
                {
                        ...
                        <View style={styles.form}>
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <View style={styles.inputWrapper}>
                                    <Ionicons name="resize-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
                                    <TextInput
                                        style={styles.input}
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <View style={styles.inputWrapper}>
                                    <Ionicons name="fitness-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
                                    <TextInput
                                        style={styles.input}
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <View style={styles.inputWrapper}>
                                    <Ionicons name="walk-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
