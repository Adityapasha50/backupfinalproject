            ...
            <SafeAreaView style={styles.container}>
                <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>Bergabunglah dengan FiteMeal untuk hidup yang lebih sehat</Text>
                    </View>
                    ...
                    <View style={styles.form}>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <View style={styles.inputWrapper}>
                                <Ionicons name="person-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
                                <TextInput
                                    style={styles.input}
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            >
                                <Ionicons name="calendar-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <View style={styles.inputWrapper}>
                                <Ionicons name="transgender-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <View style={styles.inputWrapper}>
                                <Ionicons name="lock-closed-outline" size={20} color="#8B4A6B" style={styles.inputIcon} />
                                <TextInput
                                    style={styles.input}
